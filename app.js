...
// if (a <= 20 && b >=25) {alert("Or logical operator working");}
// else if (a < b && b > a) {alert("&& logical operator working");
...
// var cities = ['Karachi', 'Lahore' , 'Islamabad' , 'Peshawar' , 'Faisalabdad']

// for( var i = 0 ; i < 2; i++ ){
//     document.write(`${cities[i]} <br/> `)
// }

// document.write(`<h1> Even Numbers</h1> <br><br>`)
// for(var i = 1; i <=100 ; i++){
...
// for( var i = 1; i <=100; i++){if (i % 2 !== 0){document.write(`${i} <br>`)}}